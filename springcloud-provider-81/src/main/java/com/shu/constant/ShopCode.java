...
public enum ShopCode {
    //正确
    SHOP_SUCCESS(true, 200, "正确"),
    //错误
    SHOP_FAIL(false, 500, "错误"),

    //付款
    SHOP_USER_MONEY_PAID(true, 1, "付款"),
    //退款
    SHOP_USER_MONEY_REFUND(true, 2, "退款"),
    SHOP_USER_MONEY_ADD(true, 3, "充值"),
    SHOP_USER_MONEY_ADDR(false, 4, "重复充值"),


    //订单未确认
    SHOP_ORDER_NO_CONFIRM(false, 0, "订单未确认"),
    SHOP_ORDER_FINISHED(true, 6, "订单已完成"),
    SHOP_ORDER_CHECK(true, 7, "订单校验完成"),
    ...
    //余额非法
    SHOP_MONEY_PAID_INVALID(false, 50002, "余额不足"),
    //Topic不能为空
